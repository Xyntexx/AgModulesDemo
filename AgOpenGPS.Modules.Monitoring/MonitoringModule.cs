...
public class MonitoringModule : IAgModule
{
    ...
    private void OnModuleLoaded(ModuleLoadedEvent evt)
    {
        var metrics = new ModuleMetrics
        {
            ...
            LoadedAt = DateTimeOffset.FromUnixTimeMilliseconds(evt.Timestamp.MonotonicMs).DateTime
        };
    ...
    private void OnModuleUnloaded(ModuleUnloadedEvent evt)
    {
        ...
        {
            metrics.UnloadedAt = DateTimeOffset.FromUnixTimeMilliseconds(evt.Timestamp.MonotonicMs).DateTime;
